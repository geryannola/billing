...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/assets/css/ace.min.css" class="ace-main-stylesheet"
        id="main-ace-style" />
    ...
    <script src="<?php echo base_url() ?>assets/assets/js/jQuery-3.5.1.min.js"></script>
                    ...
                    <li class="light-blue dropdown-modal">
                        <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                            <img class="nav-user-photo"
                                src="<?php echo base_url() ?>assets/assets/images/avatars/masjid2.jpg"
                                alt="Jason's Photo" />
                        ...
                        <ul
                            ...
                            <li>
                                <a
                                    href="<?php echo base_url() ?>login/ganti_password/<?php echo $this->session->userdata('id_username') ?>">
                            ...
                            <li>
                                <a
                                    href="<?php echo base_url() ?>login/edit_profile/<?php echo $this->session->userdata('id_username') ?>">
            ...
            <ul class="nav nav-list">
                ...
                <li class="">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="">
                            <a href="<?php echo base_url() ?>Kas_masuk">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Pemasukan
                            </a>
                            <b class="arrow"></b>
                        ...
                        <li class="">
                            <a href="<?php echo base_url() ?>Kas_keluar">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Pengeluaran
                            </a>
                            <b class="arrow"></b>
                        ...
                        <li class="">
                            <a href="<?php echo base_url() ?>rekap_kas
								">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Rekap
                            </a>
                ...
                <li class="">
                    <a href="<?php echo base_url() ?>admin/cabang">
                        ...
                        <span class="menu-text"> Setting Cabang </span>
                    </a>
                ...
                <li class="">
                    <a href="<?php echo base_url() ?>admin/pelanggan">
                        <i class="menu-icon fa fa-users"></i>
                        <span class="menu-text"> Setting Pelanggan </span>
                    </a>
                ...
                <li class="">
                    <a href="<?php echo base_url() ?>admin/paket">
                        <i class="menu-icon fa fa-users"></i>
                        <span class="menu-text"> Setting Paket </span>
                    </a>
                ...
                <li class="">
                    <a href="<?php echo base_url() ?>admin/user_level">
                        <i class="menu-icon fa fa-users"></i>
                        <span class="menu-text"> Setting User Level </span>
                    </a>
                ...
                <li class="">
                    <a href="<?php echo base_url() ?>dashboard/admin_cabang">
                        <i class="menu-icon fa fa-tachometer"></i>
                        <span class="menu-text"> Dashboard </span>
                    </a>
            ...
            <div class="footer-inner">
                <div class="footer-content">
                    <span class="bigger-120">
                        <span class="blue bolder">ABhotpot - </span>
                        &copy; 2022
                    </span>

                    &nbsp; &nbsp;
                    <!-- <span class="action-buttons">
							<a href="https://web.facebook.com/muhammadramdan599">
