    ...
    <body>
        ...
        <table class="table">
	    <tr><td>Nama Cabang</td><td><?php echo $cabang; ?></td></tr>
	    <tr><td>Alamat</td><td><?php echo $alamat; ?></td></tr>
	    <tr><td>User Mikrotik</td><td><?php echo $user_mikrotik; ?></td></tr>
	    <tr><td>Password Mikrotik</td><td><?php echo $pass_mikrotik; ?></td></tr>
	    <tr><td>IP Mikrotik</td><td><?php echo $ip_mikrotik; ?></td></tr>
