	...
	<section class="content">
		<div class="box box-warning box-solid">
			<div class="box-header with-border">
				<h3 class="box-title">INPUT DATA KAS</h3>
			</div>
			<form action="<?php echo $action; ?>" method="post">

				<table class='table table-bordered>' <tr>
					<td width='200'>Tanggal <?php echo form_error('tgl_km') ?></td>
					<td><input type="date" class="form-control" name="tgl_km" id="tgl_km" placeholder="Tgl Km" value="<?php echo $tgl_km; ?>" /></td>
					</tr>
					<tr>
						<td width='200'>Uraian <?php echo form_error('uraian_km') ?></td>
					...
					<tr>
						...
						<td><input type="number" class="form-control" name="keluar" id="keluar" placeholder="Keluar" value="<?php echo $keluar; ?>" /></td>
					</tr>
					...
					<tr>
						...
						<td><input type="hidden" name="id_km" value="<?php echo $id_km; ?>" />
							...
							<a href="<?php echo site_url('kas_keluar') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
						</td>
					</tr>
				</table>
			</form>
