									...
									<tr>
										...
										<tr>
											...
											<td style="text-align:center" width="200px">
												<?php
												echo anchor(site_url('pelanggan/rincian/' . $pelanggan->id_pelanggan), '<i class="fa fa-eye" aria-hidden="true"></i>', 'class="btn btn-success btn-sm"');
												...
												echo '  ';
												?>
												<a href="pelanggan/delete/<?= $pelanggan->id_pelanggan; ?>" class="btn btn-danger btn-sm" onclick=" return confirm('Apakah Kamu Benar Menghapus')"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
											</td>
										</tr>
									<?php
											}
