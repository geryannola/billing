		...
		<div class="box box-warning box-solid">
			...
			<form action="<?php echo $action; ?>" method="post">
				...
				<table class='table table-bordered'>
					...
					<tr>
						...
						<td>
							<select class="form-control" name="is_aktive">
								<?php $is_aktive = $data_hostpot['is_aktive'] ?>
								<?php if ($is_aktive == 1) { ?>
					...
					<tr>
						<td></td>
						<td><input type="hidden" name="id_hostpot" value="<?php echo $id_hostpot; ?>" />
							<input type="hidden" name="id_mikrotik" value="<?php echo $id_mikrotik; ?>" />
							<input type="hidden" name="id" value="<?php echo $id; ?>" />
							<button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button>
							<a href="<?php echo site_url('mikrotik/hostpot') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
						</td>
					</tr>
				</table>
			</form>
