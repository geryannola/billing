                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center" width="200px">
                                            ...
                                            echo '  ';
                                            echo anchor(site_url('kas_masuk/delete/' . $kas_masuk->id_km), '<i class="fa fa-trash-o" aria-hidden="true"></i>', 'class="btn btn-danger btn-sm" Delete', 'onclick="javasciprt: return confirm(\'Are You Sure ?\')"');
                                            ?>
                                        </td>
                                    </tr>
                                <?php
