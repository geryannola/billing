<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box box-warning box-solid">
            ...
            <form action="<?php echo $action; ?>" method="post">
                ...
                <table class='table table-bordered'>
                    ...
                    <?php if ($this->uri->segment(3) == 'create' || $this->uri->segment(3) == 'create_action') { ?>
                    <tr>
	    ...
	    <tr><td width='200'>Password <?php echo form_error('password') ?></td><td><input type="password" class="form-control" name="password" id="password" placeholder="Password" value="<?php echo $password; ?>" /></td></tr> -->
                    ...
                    <tr>
                        <td width='200'>User Level <?php echo form_error('id_level') ?></td>
                        <td><select class="form-control" name="id_level" id="id_level">
                                ...
                                <option value="<?php echo $rows['id_level'] ?>" selected>
                                    <?php echo $rows['nama_user_level'] ?></option>
                                <?php } else { ?>
                                <option value="<?php echo $rows['id_level'] ?>"><?php echo $rows['nama_user_level'] ?>
                                </option>
                                <?php } ?>
                                <?php } ?>
                            </select>
                    ...
                    <tr>
                        <td></td>
                        <td><input type="hidden" name="id_username" value="<?php echo $id_username; ?>" />
                            <button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i>
                                <?php echo $button ?></button>
                            <a href="<?php echo site_url('admin/users') ?>" class="btn btn-info"><i
