            ...
            <form action="<?php echo $action; ?>" method="post">
                ...
                <table class='table table-bordered'>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="form-control" name="nama_pelanggan" id="nama_pelanggan"
                                placeholder="Nama Pelanggan" value="<?php echo $nama_pelanggan; ?>" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="form-control" name="no_wa" id="no_wa" placeholder="No Hp/Wa"
                                value="<?php echo $no_wa; ?>" /></td>
                    </tr>
                    <tr>
                        <td width='200'>IP<?php echo form_error('ip') ?></td>
                        <td><input type="text" class="form-control" name="ip" id="ip" placeholder="IP"
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="form-control" name="r_wifi" id="r_wifi" placeholder="Nama Wifi"
                                value="<?php echo $r_wifi; ?>" /></td>
                    </tr>
                    <tr>
                        <td width='200'>Wifi Password <?php echo form_error('r_password') ?></td>
                        <td><input type="text" class="form-control" name="r_password" id="r_password"
                                placeholder="Wifi Password" value="<?php echo $r_password; ?>" /></td>
                    </tr>
                    <tr>
                        <td width='200'>Tgl Mulai <?php echo form_error('tgl_mulai') ?></td>
                        <td><input type="date" class="form-control" name="tgl_mulai" id="tgl_mulai"
                                placeholder="Tanggal Mulai" value="<?php echo $tgl_mulai; ?>" /></td>
                    </tr>
                    <tr>
                        ...
                        <td><select class="form-control" name="id_cabang" id="id_cabang">
                                ...
                                <option value="<?php echo $rows['id_cabang'] ?>" selected>
                                    <?php echo $rows['nama_cabang'] ?>
                                </option>
                                <?php } else { ?>
                                <option value="<?php echo $rows['id_cabang'] ?>"><?php echo $rows['nama_cabang'] ?>
                                </option>
                                <?php } ?>
                                <?php } ?>
                            </select>
                    ...
                    <tr>
                        ...
                        <td><select class="form-control" name="id_paket" id="id_paket">
                                ...
                                <option value="<?php echo $rows['id_paket'] ?>" selected>
                                    <?php echo $rows['service'] ?> - <?php echo $rows['nama_paket'] ?></option>
                                <?php } else { ?>
                                <option value="<?php echo $rows['id_paket'] ?>">
                                    <?php echo $rows['service'] ?> - <?php echo $rows['nama_paket'] ?>
                                </option>
                                <?php } ?>
                                <?php } ?>
                            </select>
                    ...
                    <tr>
                        ...
                        <td><input type="hidden" name="id_pelanggan" value="<?php echo $id_pelanggan; ?>" />
                            ...
                            <input type="text" name="id_mikrotik_user" value="<?php echo $id_mikrotik_user; ?>" />
                            <button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i>
                                <?php echo $button ?></button>
                            <a href="<?php echo site_url('admin/pelanggan') ?>" class="btn btn-info"><i
