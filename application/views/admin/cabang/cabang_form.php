        ...
        <div class="box box-warning box-solid">
            ...
            <form action="<?php echo $action; ?>" method="post">
                ...
                <table class='table table-bordered'>
                    <tr>
                        <td width='200'>Nama <?php echo form_error('cabang') ?></td>
                        <td><input type="text" class="form-control" name="cabang" id="cabang" placeholder="cabang"
                                value="<?php echo $cabang; ?>" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="form-control" name="user_mikrotik" id="user_mikrotik"
                                placeholder="User Mikrotik" value="<?php echo $user_mikrotik; ?>" /></td>
                    </tr>
                    <tr>
                        <td width='200'>Password Mikrotik <?php echo form_error('pass_mikrotik') ?></td>
                        <td><input type="text" class="form-control" name="pass_mikrotik" id="pass_mikrotik"
                                placeholder="Password Mikrotik" value="<?php echo $pass_mikrotik; ?>" /></td>
                    </tr>
                    <tr>
                        <td width='200'>IP Mikrotik <?php echo form_error('ip_mikrotik') ?></td>
                        <td><input type="text" class="form-control" name="ip_mikrotik" id="ip_mikrotik"
                                placeholder="IP Mikrotik" value="<?php echo $ip_mikrotik; ?>" /></td>
                    </tr>
                    <tr>
                        <td width='200'>Domain <?php echo form_error('domain') ?></td>
                        <td><input type="text" class="form-control" name="domain" id="domain" placeholder="Domain"
                                value="<?php echo $domain; ?>" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="hidden" name="id_cabang" value="<?php echo $id_cabang; ?>" />
                            ...
                            <a href="<?php echo site_url('admin/cabang') ?>" class="btn btn-info"><i
