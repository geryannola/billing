<div class="content-wrapper">
    <section class="content">
		...
		<!-- <?php echo anchor(site_url('tagihan/word'), '<i class="fa fa-file-word-o" aria-hidden="true"></i> Export Ms Word', 'class="btn btn-primary btn-sm"'); ?> -->
	</div>
            </div>
            <div class=' col-md-3'>
                                <form action="<?php echo site_url('tagihan/index'); ?>" class="form-inline"
                                    method="get">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
											...
											if ($q <> '') {
											?>
                                            <a href="<?php echo site_url('tagihan'); ?>"
                        ...
                        <div class="box-body" style="overflow-x: scroll; ">
                            <table class="table table-bordered" style="margin-bottom: 10px">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $tagihan->nama_cabang ?></td>
                                    ...
                                    <td style="text-align:center" width="200px">
                                        <?php
											...
											echo '  ';
											?>
                                        <a href="tagihan/delete/<?= $tagihan->id_tagihan; ?>"
