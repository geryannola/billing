                ...
                <table class='table table-bordered'>
                    <tr>
                        ...
                        <td><select class="form-control" name="id_pelanggan" id="id_pelanggan">
                                ...
                                <option value="<?php echo $rows['id_pelanggan'] ?>" selected>
                                    <?php echo $rows['nama_cabang'] ?> - <?php echo $rows['nama_pelanggan'] ?></option>
                                <?php } else { ?>
                                <option value="<?php echo $rows['id_pelanggan'] ?>"><?php echo $rows['nama_cabang'] ?> -
                                    <?php echo $rows['nama_pelanggan'] ?></option>
                                <?php } ?>
                                <?php } ?>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td><select class="form-control" name="bulan" id="bulan">
                                ...
                                <option value="<?php echo $rows['id_bulan'] ?>" selected>
                                    <?php echo $rows['nama_bulan'] ?></option>
                                <?php } else { ?>
                                <option value="<?php echo $rows['id_bulan'] ?>"><?php echo $rows['nama_bulan'] ?>
                                </option>
                                <?php } ?>
                                <?php } ?>
                            </select>
                    ...
                    <tr>
                        ...
                        <td><select class="form-control" name="tahun" id="tahun">
                                ...
                                <option value="<?php echo $rows['tahun'] ?>" selected><?php echo $rows['tahun'] ?>
                                </option>
                                <?php } else { ?>
                    ...
                    <tr>
                        ...
                        <td><input type="hidden" name="id_tagihan" value="<?php echo $id_tagihan; ?>" />
                            ...
                            <a href="<?php echo site_url('tagihan') ?>" class="btn btn-info"><i
