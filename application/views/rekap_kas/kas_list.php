								...
								<tr>
									...
									<tr>
										...
										<td style="text-align:center" width="200px">
											...
											echo '  ';
											?>
											<a href="rekap_kas/delete/<?= $rekap_kas->id_km; ?>" class="btn btn-danger btn-sm" onclick=" return confirm('Apakah Kamu Benar Menghapus')"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
										</td>
									</tr>
								<?php
										}
