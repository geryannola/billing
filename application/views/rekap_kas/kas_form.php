			...
			<form action="<?php echo $action; ?>" method="post">
				...
				<table class='table table-bordered>' <tr>
					...
					<tr>
						...
						<td><input type="text" class="form-control" name="masuk" id="masuk" placeholder="Masuk" value="<?php echo $masuk; ?>" /></td>
					</tr>
					<tr>
						<td width='200'>Keluar <?php echo form_error('keluar') ?></td>
						<td><input type="text" class="form-control" name="keluar" id="keluar" placeholder="Keluar" value="<?php echo $keluar; ?>" /></td>
					</tr>
					<tr>
						<td width='200'>Jenis <?php echo form_error('jenis') ?></td>
						<td><input type="text" class="form-control" name="jenis" id="jenis" placeholder="Masuk / Keluar" value="<?php echo $jenis; ?>" /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="hidden" name="id_km" value="<?php echo $id_km; ?>" />
							...
							<a href="<?php echo site_url('rekap_kas') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
						</td>
					</tr>
				</table>
			</form>
