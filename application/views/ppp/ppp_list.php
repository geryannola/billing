<div class="content-wrapper">
	<section class="content">
			...
			<div class="col-xs-12">
				<div class="box box-warning box-solid">
					...
					<div class="box-header">
						<h3 class="box-title">KELOLA DATA PPP</h3>
					</div>
		...
		<?php echo anchor(site_url('mikrotik/ppp/active'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> PPP Aktive', 'class="btn btn-success btn-sm"'); ?></div>
            </div>
            <div class=' col-md-3'>
									...
									<tr>
										...
										<tr>
											...
											<td style="text-align:center" width="200px">
												...
												echo '  ';
												?>
												<a href="ppp/delete/<?= $route->id_ppp; ?>" class="btn btn-danger btn-sm" onclick=" return confirm('Apakah Kamu Benar Menghapus')"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
											</td>
										</tr>
									<?php
											}
