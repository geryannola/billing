...
class Cabang extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('template', 'admin/cabang/cabang_list', $data);
    }
    ...
    public function read($id)
    {
        ...
        if ($row) {
            ...
            $this->template->load('template', 'admin/cabang/cabang_read', $data);
        } else {
    ...
    public function create()
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('admin/cabang/create_action'),
        ...
        $this->template->load('template', 'admin/cabang/cabang_form', $data);
    }
    ...
    public function update($id)
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('admin/cabang/update_action'),
