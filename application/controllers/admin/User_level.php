...
class User_level extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . '.php/admin/c_url/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'index.php/admin/user_level/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'index.php/admin/user_level/index/';
            $config['first_url'] = base_url() . 'index.php/admin/user_level/index/';
        }
        ...
        $this->template->load('template','admin/user_level/user_level_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'nama_user_level' => $row->nama_user_level,
            ...
            $this->template->load('template','admin/user_level/user_level_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('admin/user_level'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('admin/user_level/create_action'),
	    'id_level' => set_value('id_level'),
	    'nama_user_level' => set_value('nama_user_level'),
	);
        $this->template->load('template','admin/user_level/user_level_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('admin/user_level/update_action'),
